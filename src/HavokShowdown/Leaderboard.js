...
function Leaderboard() {
    ...
    const [page, setPage] = useState([0, 30])
    ...
    return (
        <div className='leaderboard_havok'> 
                ...
                <div className='leaderbaord_page'>
                    <div className='leaderboard_table table1'>
                        <div className='header_container'>
                            ...
                            <div style={{fontSize: '8px'}} className='info_header'>PLACE MOY.</div>
                            <div className='info_header'>ÉLIM.</div>
                            <div className='info_header'>WINS</div>
                            <div onClick={nextPage} className='info_header'>PTS</div>
                        </div>
                        {leaderboard ? leaderboard.slice(page[0],(page[1]-22)).map(data => <Row rank={data.place} teamname={data.teamname} points={data.points} elims={data.elims} wins={data.wins} avg_place={data.avg_place}/>) : ''}
                    </div>
                    <div className='leaderboard_table table2'>
                        ...
                        {leaderboard ? leaderboard.slice(page[0]+8,page[1]-14).map(data => <Row rank={data.place} teamname={data.teamname} points={data.points} elims={data.elims} wins={data.wins} avg_place={data.avg_place}/>) : ''}
                    </div>
                    <div className='leaderboard_table table3'>
                        ...
                        {leaderboard ? leaderboard.slice(page[0]+16,page[1]-6).map(data => <Row rank={data.place} teamname={data.teamname} points={data.points} elims={data.elims} wins={data.wins} avg_place={data.avg_place}/>) : ''}
                    </div>
                    <div className='leaderboard_table table4'>
                        <div className='header_container'>
                            <div className='rank_header' onClick={previousPage} >TOP</div>
                            <div className='name_header'>JOUEUR</div>
                            <div style={{fontSize: '8px'}} className='info_header'>PLACE MOY.</div>
                        ...
                        {leaderboard ? leaderboard.slice(page[0]+24,page[1]).map(data => <Row rank={data.place} teamname={data.teamname} points={data.points} elims={data.elims} wins={data.wins} avg_place={data.avg_place}/>) : ''}
                    </div>
                </div>
            </div>
        </div>
