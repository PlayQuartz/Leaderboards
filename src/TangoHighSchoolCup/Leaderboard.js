...
function LeaderboardTangoHighSchoolCup() {
    ...
    return (
        <div className='tango-high-school-cup' style={{backgroundImage: `url(${Background})`}}> 
...
export default LeaderboardTangoHighSchoolCup